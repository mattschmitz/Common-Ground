...
Use github’s interface to make a fork of the repo, then add the main repo as an upstream remote:

```
git remote add upstream https://github.com/hrsf73-genial-giraffes/genial-giraffes.git
```
